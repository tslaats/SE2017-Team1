...
public class ResponseStackedFlipped extends JPanel {
   ...
   * - rel = new ConresRelation(act2, act1, "resp")
   */
  ...
  public static void main(String[] args) {
    String fileName = "images/resp_stack_flip";
    ResponseStackedFlipped graphDrawing = new ResponseStackedFlipped();
