...
public class semanticsTest {
	...
	/*
	 * This data initialization is provided by visualization group since we do
	 * not really test the petri net but rather its semantics
	 */
	@BeforeClass
